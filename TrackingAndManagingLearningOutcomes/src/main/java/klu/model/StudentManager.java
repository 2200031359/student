...
public class StudentManager {
	...
	StudentRepository SR;
	 @Autowired
	    StudentCourseMappingRepository SCMappingRepository;
	...
	public String loginStudent(String uname, String pwd) { // Take username and password
	 ...
	 public List<Courses> getMappedCoursesForStudent(long studentId) {
	        // Fetch the courses that are mapped to the student
	        return SCMappingRepository.findCoursesByStudentId(studentId);
	    }
